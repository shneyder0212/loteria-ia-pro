...
app = FastAPI(title="Shneyder IA Pro RD - Titan Quantum v49.0")
...
def obtener_jalamatico(num_str):
    return TABLA_JALADERA.get(num_str, [num_str[::-1], "{}x".format((int(num_str)+10)%100), "{}x".format((int(num_str)+50)%100)])
...
def index(request: Request):
    ...
    <head>
        ...
        <title>Shneyder IA Pro RD v49.0</title>
        <style>
