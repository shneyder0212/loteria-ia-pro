        ...
        <script>
            ...
            function actualizarVista() {{
                ...
                if (info.tipo_juego === 'quiniela' && info.rankings) {{
                    ...
                    html += `<p style="color:#facc15; font-weight:bold;">🇪🇸 Reintegro: <span style="font-size:18px; color:#fff;">${{info.primitiva_data.reintegro}}</span></p>`;
                    html += "<h3>🇪🇸 MATRIZ PRIMITIVA:</h3><div style='text-align:center; margin:15px 0;'>";
